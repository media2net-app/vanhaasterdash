        ...
        >
          {!mapLoaded ? (
            <div className="text-center">
              <div className="text-[#E2017A] text-lg font-medium mb-2">Mapbox Route</div>
              <div className="text-gray-400 text-sm">Route optimalisatie met Mapbox GL JS</div>
              <div className="text-gray-500 text-xs mt-2">Hoogeveen → Emmen → Assen → Groningen</div>
            </div>
          ) : (
            <div className="text-center">
              <div className="text-green-400 text-lg font-medium mb-2">Mapbox Geladen</div>
